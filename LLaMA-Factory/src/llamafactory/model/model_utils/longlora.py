...
# In transformers >= 4.50, attention classes were unified into LlamaAttention
try:
    from transformers.models.llama.modeling_llama import LlamaFlashAttention2, LlamaSdpaAttention
except ImportError:
    # For newer transformers versions, use LlamaAttention as fallback
...
def _apply_llama_patch() -> None:
    require_version("transformers>=4.51.0", "To fix: pip install transformers>=4.51.0")
